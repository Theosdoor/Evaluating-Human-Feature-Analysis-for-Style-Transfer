...
\begin{table}[t]
  ...
  \begin{tabular}{ll}
    ...
    Training time (2.1)  & \textasciitilde{}X min \\
    Training time (2.2)  & \textasciitilde{}X min \\
    \bottomrule
  \end{tabular}
\end{table}
...
%     \midrule
%     Game $\to$ Movie (AtoB) & 234.4 & 0.081 & 0.368 \\
%     Movie $\to$ Game (BtoA) & 143.6 & 0.051 & 0.712 \\
%     \bottomrule
%   \end{tabular}
% \end{table}
...
%            (patch-level CUT with ST-GCN classification), game$\to$movie
%            direction. FID/KID measure distance to the target domain
%            distribution; LPIPS measures perceptual change vs.\ input.
%            FID favours 2.1 because global FID penalises untranslated
%            background pixels in the local compositing approach of 2.2.}
%   \label{tab:metrics22}
%   \begin{tabular}{lrrr}
%     \toprule
%     Model & FID\,$\downarrow$ & KID\,$\downarrow$ & LPIPS\,$\downarrow$ \\
%     \midrule
%     2.1 Full-frame CUT          & 234.4 & 0.081 & 0.368 \\
%     2.2 Patch CUT + ST-GCN      & 242.5 & 0.093 & \textbf{0.359} \\
%     \bottomrule
%   \end{tabular}
% \end{table}
